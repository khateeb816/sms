...
<head>
    ...
    <title>Register - Dashtreme Admin</title>
    <!-- loader-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative has-icon-right">
                                <input type="text" id="name" name="name"
                                    class="form-control input-shadow @error('name') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative has-icon-right">
                                <input type="password" id="password-confirm" name="password_confirmation"
                                    class="form-control input-shadow" placeholder="Confirm Your Password" required

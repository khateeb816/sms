...
@section('title', 'Manage Test Results')
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <h4 class="page-title">Manage Test Results</h4>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('tests.store-results', $test) }}" method="POST">
                            @csrf
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                        $result = $test->results->where('student_id', $student->id)->first();
                                        @endphp
                                        <tr>
                                            <td>
                                                {{ $student->name }}
                                            ...
                                            <td>
                                                <input type="number"
                                                    ...
                                                    min="0" max="{{ $test->total_marks }}" required>

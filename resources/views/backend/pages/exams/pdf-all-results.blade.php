...
<body>
    <div class="header">
        ...
        <div class="report-title">All Examination Results Report</div>
    </div>

    @foreach($datesheets as $index => $datesheet)
        @if($index > 0)
            <div class="page-break"></div>
        @endif

        <div class="datesheet-section">
            <div class="datesheet-info">
                <div class="datesheet-title">{{ $datesheet->title }}</div>
                <div class="info-row">
                    <span class="info-label">Class:</span> {{ $datesheet->class->name }}
                </div>
                <div class="info-row">
